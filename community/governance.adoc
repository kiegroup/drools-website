...
The project lead will then publish the roadmap on link:product.html[the developer mailing list],
and update the version information in link:../code/issueTracker.html[JIRA].

drools is the basis for the commercial (yet open source) link:product.html[BRMS and BPM Suite products],
...
Lobbying for features using the voting feature in link:../code/issueTracker.html[JIRA],
and posting to link:product.html[the community forum], is a great way to express interest as well.
