...
<#macro layout>
    <@parent.layout>
        ...
        <div class="paragraph summaryParagraph">
            <p><strong>KIE public API classes are backwards compatible</strong> (per series),
                but users often also use implementation classes (which are documented in the reference manual too).
                This upgrade recipe <em>minimizes the pain</em> to upgrade your code.</p>
        </div>
        <div class="row">
            <div class="col-md-7">
