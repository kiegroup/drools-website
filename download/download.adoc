 ...
 * Release notes: #{site.pom.latestFinal.droolsReleaseNotes}[#{site.pom.latestFinal.version}]
 ...
 * Release notes: #{site.pom.latest.droolsReleaseNotes}[#{site.pom.latest.version}]
 * License: link:../code/license.html[ASL 2.0]
 ...
 * Release notes: #{site.pom.latest_65x.droolsReleaseNotes}[#{site.pom.latest_65x.version}]
 * License: link:../code/license.html[ASL 2.0]
