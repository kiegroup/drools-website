...
* #{site.pom.latest.droolsWorkbenchTomcatWAR}[Tomcat 7+ WAR]: The current KIE Workbench #{site.pom.latest.version} build is not deployable on Tomcat, please use WildFly for now.
