...
* The latest releases, including 6.3.0.Beta1 are available on the http://search.maven.org/#search|ga|1|org.drools[central maven repository].
...
* http://download.jboss.org/drools/release/6.3.0.Beta1/org.drools.updatesite/[Click here] to go to the Drools and jBPM update site 6.3.0.Beta1.
