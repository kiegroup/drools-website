...
The Drools distribution zip includes binaries, documentation, examples and sources.

* image:download.png[] *#{site.pom.latestFinal.distributionZip}[Download Drools #{site.pom.latestFinal.version}]*
