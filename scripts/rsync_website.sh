...
#   Then you should use:
#   rsync --dry-run -Pavqr -e "ssh -i $HOME/.ssh/drools/id_rsa" --protocol=28 --delete-after target/website/* drools@filemgmt.jboss.org:www_htdocs/drools
...
rsync -Pavqr --protocol=28 --delete-after target/website/* drools@filemgmt.jboss.org:www_htdocs/drools
